...
export const ingredientsDatabase: Ingredient[] = [
  ...
  { id:'chicken-cooked',   name:'Cooked Chicken (diced)', category:'filling',   calories:165, protein:31.0, fat:3.6,  carbs:0.0,  sugar:0.0,  fiber:0.0,  sodium:74,    moisture:65, defaultAmount:400 },
  { id:'turkey-cooked',    name:'Cooked Turkey (diced)',  category:'filling',   calories:189, protein:29.0, fat:7.0,  carbs:0.0,  sugar:0.0,  fiber:0.0,  sodium:103,   moisture:58, defaultAmount:400 },
  { id:'mushroom-sliced',  name:'Mushrooms (sliced)',     category:'filling',   calories:22,  protein:3.1,  fat:0.3,  carbs:3.3,  sugar:2.0,  fiber:1.0,  sodium:5,     moisture:92, defaultAmount:300 },
  { id:'peas-frozen',      name:'Green Peas (frozen)',    category:'fruit',     calories:81,  protein:5.4,  fat:0.4,  carbs:14.0, sugar:5.7,  fiber:5.1,  sodium:300,   moisture:79, defaultAmount:150 },
  { id:'celery-diced',     name:'Celery (diced)',         category:'fruit',     calories:14,  protein:0.7,  fat:0.2,  carbs:3.0,  sugar:1.3,  fiber:1.6,  sodium:80,    moisture:95, defaultAmount:100 },
  { id:'onion-diced',      name:'Yellow Onion (diced)',   category:'fruit',     calories:40,  protein:1.1,  fat:0.1,  carbs:9.3,  sugar:4.2,  fiber:1.7,  sodium:4,     moisture:89, defaultAmount:150 },
  { id:'carrot-diced',     name:'Carrot (diced)',         category:'fruit',     calories:41,  protein:0.9,  fat:0.2,  carbs:9.6,  sugar:4.7,  fiber:2.8,  sodium:69,    moisture:88, defaultAmount:120 },
  { id:'lamb-ground',      name:'Ground Lamb',            category:'filling',   calories:282, protein:16.6, fat:23.0, carbs:0.0,  sugar:0.0,  fiber:0.0,  sodium:72,    moisture:58, defaultAmount:450 },
  { id:'beef-ground',      name:'Ground Beef (lean)',    category:'filling',   calories:250, protein:26.0, fat:15.0, carbs:0.0,  sugar:0.0,  fiber:0.0,  sodium:72,    moisture:64, defaultAmount:450 },
  { id:'potato-russet',    name:'Russet Potato (for mash)', category:'fruit',   calories:77,  protein:2.0,  fat:0.1,  carbs:17.0, sugar:0.8,  fiber:2.1,  sodium:6,     moisture:79, defaultAmount:800 },
  { id:'worcestershire',   name:'Worcestershire Sauce',   category:'liquid',    calories:78,  protein:0.0,  fat:0.0,  carbs:19.0, sugar:10.0, fiber:0.0,  sodium:980,   moisture:80, defaultAmount:15 },
