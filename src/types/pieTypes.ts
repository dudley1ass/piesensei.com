...

  {
    ...
    pies: [
      { id: 'chicken-pot-pie', name: 'Classic Chicken Pot Pie', emoji: '\u{1F357}', description: 'Tender chicken, carrots, peas, and celery in a rich cream gravy — sealed under a golden flaky crust.', techniqueTip: 'Cool the filling to room temperature before adding to the crust — hot filling softens the butter fat and prevents flakiness.',
        ingredients: [{name:'All-Purpose Flour',amount:345},{name:'Unsalted Butter',amount:255},{name:'Ice Water',amount:80},{name:'Salt',amount:13},{name:'Chicken Broth',amount:480},{name:'Whole Milk',amount:240},{name:'Cooked Chicken (diced)',amount:450},{name:'Carrot (diced)',amount:120},{name:'Green Peas (frozen)',amount:150},{name:'Celery (diced)',amount:100},{name:'Yellow Onion (diced)',amount:120},{name:'Black Pepper',amount:3},{name:'Thyme',amount:2}]},
      { id: 'turkey-mushroom', name: 'Turkey & Mushroom Pot Pie', emoji: '\u{1F983}', description: 'Leftover turkey and savory mushrooms in a golden double-crust pie — the best use of holiday turkey.', techniqueTip: 'Brown mushrooms in batches in a hot dry pan until deeply golden — releasing liquid concentrates flavor.',
        ingredients: [{name:'All-Purpose Flour',amount:350},{name:'Unsalted Butter',amount:255},{name:'Ice Water',amount:80},{name:'Salt',amount:8},{name:'Chicken Broth',amount:480},{name:'Heavy Cream',amount:120},{name:'Cooked Turkey (diced)',amount:450},{name:'Mushrooms (sliced)',amount:300},{name:'Yellow Onion (diced)',amount:100},{name:'Thyme',amount:3},{name:'Black Pepper',amount:3}]},
      { id: 'shepherds-pie', name: "Shepherd's Pie (Lamb)", emoji: '\u{1F411}', description: 'Traditional British shepherd\'s pie — minced lamb with rosemary under a golden mashed potato crust.', techniqueTip: 'Pipe mashed potato with a star tip for crisp ridges that brown dramatically.',
        ingredients: [{name:'Ground Lamb',amount:450},{name:'Yellow Onion (diced)',amount:150},{name:'Carrot (diced)',amount:100},{name:'Green Peas (frozen)',amount:100},{name:'Unsalted Butter',amount:140},{name:'All-Purpose Flour',amount:30},{name:'Chicken Broth',amount:300},{name:'Russet Potato (for mash)',amount:900},{name:'Whole Milk',amount:120},{name:'Salt',amount:10},{name:'Black Pepper',amount:4},{name:'Thyme',amount:2},{name:'Rosemary',amount:2}]},
      { id: 'cottage-pie', name: 'Cottage Pie (Beef)', emoji: '\u{1F404}', description: 'Minced beef with Worcestershire, carrot, and onion under a thick mashed potato crust.', techniqueTip: 'Add an egg yolk to the mashed potato topping — it accelerates Maillard browning for a deeper golden crust.',
        ingredients: [{name:'Ground Beef (lean)',amount:450},{name:'Yellow Onion (diced)',amount:150},{name:'Carrot (diced)',amount:120},{name:'Worcestershire Sauce',amount:18},{name:'Unsalted Butter',amount:115},{name:'All-Purpose Flour',amount:35},{name:'Chicken Broth',amount:360},{name:'Russet Potato (for mash)',amount:900},{name:'Whole Milk',amount:120},{name:'Salt',amount:8},{name:'Black Pepper',amount:4},{name:'Thyme',amount:2}]},
    ],
  },
